...
const serviceImages = [
  { img: "/images/abstract-1.png", url: "#" },
  { img: "/images/abstract-2.png", url: "#" },
  { img: "/images/abstract-3.png", url: "#" },
                    ...
                    >
                      <InView
                        variants={{
                          ...
                          visible: { opacity: 1, scale: 1, y: 0, filter: "blur(0.01px)", transition: { delay: 0.01, duration: 0.5 } },
                        }}
                        viewOptions={{ margin: "0px 0px -250px 0px", once: true }}
                        transition={{ duration: 0.3, ease: "easeInOut" }}
                      >
                        <Link href={serviceImages[index]?.url ?? "#"}>
                          <Image
